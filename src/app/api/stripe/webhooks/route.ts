import { manageSubscriptionStatusChange, updateStripeCustomer } from "@/actions/stripe"
...
export async function POST(req: Request) {
  if (!features.stripe || !stripe || !features.supabase) {
    return new Response("Stripe is disabled", { status: 404 })
  }
