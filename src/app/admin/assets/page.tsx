...
const OmniCommandPalette = lazy(() => import("@/components/dam/OmniCommandPalette").then(mod => ({ default: mod.OmniCommandPalette })))
const TagEditor = lazy(() => import("@/components/dam/TagEditor").then(mod => ({ default: mod.TagEditor })))
const CollectionManager = lazy(() => import("@/components/dam/CollectionManager").then(mod => ({ default: mod.CollectionManager })))

// Import type for CommandItem
import type { CommandItem } from "@/components/dam/OmniCommandPalette"
...
export default function DAMPage() {
  ...
  const fetchTeamMembers = useCallback(async () => {
    try {
      const response = await fetch("/api/admin/assets/team-members")
