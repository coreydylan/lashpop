...
function formatPlatformRating(rating: string): string {
  const value = Number(rating)
  return Number.isFinite(value) ? value.toFixed(1) : rating
}
              ...
              {[...reviewStats].sort((a, b) => {
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-sans font-semibold text-dune text-base">{formatPlatformRating(stat.rating)}</span>
            ...
            <div className="md:hidden flex justify-center gap-3 mb-6 px-4">
              {[...reviewStats].sort((a, b) => {
                ...
                >
                  ...
                  <span className="font-sans font-semibold text-dune text-sm">{formatPlatformRating(stat.rating)}</span>
