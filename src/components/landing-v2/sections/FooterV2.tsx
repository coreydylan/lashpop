...
interface FooterV2Props {
  /**
   * Studio identity (name, address, phone, email, social URLs, hours).
   * Falls back to DEFAULT_STUDIO_SETTINGS when the prop is absent — keeps
   * the component renderable in isolation (Storybook, /work-with-us
    ...
    <footer ref={ref} className="bg-ivory pt-8 md:pt-20 pb-8">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-20 mb-16">
          {/* Brand Column */}
          <div>
            <h3 className="heading-4 mb-4" style={{ color: '#ac4d3c' }}>{studio.name}</h3>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {studio.social.google && (
                <a
                  href={studio.social.google}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-dusty-rose/20 rounded-full flex items-center justify-center hover:bg-terracotta hover:text-white transition-colors"
                  aria-label="Google"
              ...
              {studio.social.vagaro && (
                <a
                  href={studio.social.vagaro}
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <div>
            ...
            <address className="not-italic space-y-4">
              ...
              >
                ...
                <span>{studio.address.street}<br />{studio.address.city}, {studio.address.state} {studio.address.zip}</span>
              </a>
              <a
            ...
            <div className="mt-4">
              ...
              <p className="caption text-charcoal whitespace-pre-line">
                {studio.hoursShort}
              </p>
            </div>
          </div>
