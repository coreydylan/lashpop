      ...
      <div className="container">
        ...
        >
          ...
          <div>
            ...
            <p className="body-text text-dune/70 mb-6">
              North County San Diego's premier lash extension studio. Award-winning artistry in Oceanside, CA.
            </p>
          ...
          <div>
            ...
            <address className="not-italic space-y-3" itemScope itemType="https://schema.org/LocalBusiness">
              ...
              <p className="caption text-dune/70">
                <a href="tel:+17602120448" itemProp="telephone" onClick={trackPhoneClick} className="hover:text-dusty-rose transition-colors">
                  +1 (760) 212-0448
                </a>
              </p>
              <p className="caption text-dune/70">
                <a href="mailto:hello@lashpopstudios.com" itemProp="email" onClick={trackEmailClick} className="hover:text-dusty-rose transition-colors">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-2">
            ...
            <span className="caption text-dune/60">•</span>
