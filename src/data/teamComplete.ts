...
export const teamMembers: TeamMember[] = [
  // Ordered per client request
  {
    ...
    phone: '760-212-0448',
    specialties: ['Lash Extensions', 'Volume Lashes', 'Classic Lashes'],
  ...
  },
  {
    ...
    availability: 'By appointment',
    instagram: '@pacificlashesbypaige',
    bookingUrl: 'https://www.vagaro.com/lashpop32',
    type: 'independent',
    favoriteServices: ['Lash Extensions'],
    funFact: ''
  },
  {
    id: 4,
  ...
  },
  {
    ...
    certification: 'Esthetician, Microblading/PMA Certified',
    businessName: 'Brows by Cat Black',
    image: '/lashpop-images/team/renee-belton.jpg',
    phone: '760-579-1309',
    specialties: ['Microblading', 'Brows', 'Lash Lifts'],
  ...
  },
  {
    ...
    phone: '760-822-0255',
    specialties: ['HydraFacials', 'Lash Extensions', 'Skincare'],
  ...
  },
  {
    ...
    phone: '949-866-2206',
    specialties: ['Lash Extensions', 'Brows'],
  ...
  },
  {
    ...
    phone: '619-735-1237',
    specialties: ['Lash Extensions', 'Brows', 'Skincare'],
    ...
    funFact: 'Favorite show is Survivor.'
  },
  {
    id: 11,
    name: 'Haley Walker',
    ...
    funFact: 'Enjoys renovating her 1960\'s home.'
  },
  {
    id: 12,
  ...
  },
  {
    ...
    phone: '760-212-0448',
    specialties: ['Lash Extensions'],
    bio: 'Kelly R brings precision and care to every lash set, ensuring each client leaves feeling confident and beautiful.',
    availability: 'By appointment',
    instagram: '@lashpopstudios',
    bookingUrl: 'https://www.vagaro.com/lashpop32',
    type: 'independent',
  ...
  },
  {
    ...
    phone: '760-212-0448',
    specialties: ['Lash Extensions'],
    bio: 'Kimberley brings dedication and artistry to every set, creating beautiful lashes tailored to each client.',
    availability: 'By appointment',
    instagram: '@lashpopstudios',
    bookingUrl: 'https://www.vagaro.com/lashpop32',
    type: 'independent',
    favoriteServices: ['Lash Extensions'],
    funFact: 'Fun fact: she\'s a twin!'
  },
  {
    id: 15,
    name: 'Elena Castellanos',
    role: 'Plasma Specialist',
    certification: 'Certified Fibroblast and Jet Plasma Technician',
    businessName: 'Nuskin Fibroblast',
    image: '/lashpop-images/team/elena-castellanos.jpeg',
    phone: '760-583-3357',
    specialties: ['Jet Plasma', 'Fibroblast', 'Skin Tightening'],
  ...
  },
  {
    ...
    name: 'Grace Ramos',
    role: 'Nurse Injector',
    certification: 'RN, Women\'s Health Nurse Practitioner, Facial Esthetics Certified',
    businessName: 'Naturtox',
    image: '/lashpop-images/team/grace-ramos.jpg',
    phone: '760-525-8628',
    specialties: ['Botox'],
    bio: 'Grace brings medical expertise to aesthetic enhancement. As a certified nurse injector, she specializes in natural-looking results with Botox.',
    quote: 'Subtle enhancements, natural results.',
    availability: 'By appointment',
    instagram: '@natur_tox',
    bookingUrl: 'https://www.naturtox.com/book-now',
    type: 'independent',
    favoriteServices: ['Botox'],
  ...
  },
  {
    ...
    phone: '760-212-0448',
    specialties: ['Lash Extensions'],
    bio: 'Nancy brings years of experience and a keen eye for detail to every lash appointment.',
    availability: 'By appointment',
    instagram: '@lashpopstudios',
    bookingUrl: 'https://www.vagaro.com/lashpop32',
    type: 'independent',
    favoriteServices: ['Lash Extensions'],
    funFact: 'I remember my clients\' lash maps better than my passwords.'
  },
  {
    id: 18,
    name: 'Ryann Alcorn',
